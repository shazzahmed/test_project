                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        TinyColor.fromColor(Theme.of(context).primaryColor).darken(20).color,
                        TinyColor.fromColor(Theme.of(context).primaryColor).darken(15).color,
                        TinyColor.fromColor(Theme.of(context).primaryColor).darken(8).color,
                        TinyColor.fromColor(Theme.of(context).primaryColor).lighten(3).color,
                        TinyColor.fromColor(Theme.of(context).primaryColor).lighten(5).color,
                      ],
                    ),
                  ),
                  child: Container(
